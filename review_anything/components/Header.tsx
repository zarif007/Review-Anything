...
const Header = () => {
  ...
  const styles = {
    nav: `pt-3 shadow-sm ${isDark ? 'bg-[#0E0E10] shadow-black' : 'bg-[#FAF9F6] shadow-[#a1a1aa]'}  sticky top-0 z-50 pb-2`,
    ...
    icon: `h-10 w-6 sm:h-12 sm:w-8  ${isDark ? 'text-gray-200' : 'text-gray-900'} iconAnimation`,
