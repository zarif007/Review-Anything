...
const SignIn: React.FC<{providers: providersInterface}> = ({ providers }) => {
  ...
  const styles = {
    ...
    provider: `${isDark ? 'hover:bg-[#131313] bg-[#030303] border-gray-900 text-white' : 'hover:bg-[#F9F6EE] bg-[#fefefa] border-gray-200 text-black'}  border-2  p-3 rounded-sm font-semibold flex text-lg space-x-2`,
  }
